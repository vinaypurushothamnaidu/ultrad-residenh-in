...
loaders_ = {
	'residenhitstrain':Its_train_loader,
	'residenhval':Its_test_loader
}
...
# ! python /kaggle/working/ultrad-ihaze/main.py --net='ultrad' --bs=10 --lr=0.0003 --trainset='ihazetrain' --testset='ihazeval' --steps=500000 --eval_step=5