...
parser.add_argument('--trainset',type=str,default='residenhitstrain')
parser.add_argument('--testset',type=str,default='residenhval')
parser.add_argument('--net',type=str,default='ultrad')
